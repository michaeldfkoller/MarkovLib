...
b = time.time()
print(" 1 Result %f (%8.1f)" % (a.dGetMeanDK(0,1),time.time()-b))
b = time.time()
print(" 10 Result %f (%8.1f)" % (a.dGetMeanDK(0,11),time.time()-b))
b = time.time()
print(" 100 Result %f (%8.1f)" % (a.dGetMeanDK(0,111),time.time()-b))
b = time.time()
print(" 1000 Result %f (%8.1f)" % (a.dGetMeanDK(0,1111),time.time()-b))
b = time.time()
print(" 10000 Result %f (%8.1f)" % (a.dGetMeanDK(0,11111),time.time()-b))
b = time.time()
print(" 100000 Result %f (%8.1f)" % (a.dGetMeanDK(0,111111),time.time()-b))
b = time.time()
