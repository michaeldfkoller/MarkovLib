...
# Get DK and CF Person i
    ...
    def CalcSim(self):
        ...
        for k in range(self.NrSim):
            XOmega = exp(self.mu * numpy.ones((100,1), dtype='f') + self.sigma * randn(100,1))
...
#############################################################################################################    
        ...
        io.write_array(outFile,  s.CF_Sim.transpose())
        outFile.close()
